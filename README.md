...
- Quick commands
- Smooth animations
- 14 built-in color presets + example theme (Noir)
- Custom user themes and customizable window size & corner rounding

---

## 📦 Installation (Arch Linux)

![Downloads](https://img.shields.io/github/downloads/Wemite/smoothysearch/total) [![Download](https://img.shields.io/badge/Download-latest%20release-blue?style=for-the-badge)](https://github.com/Wemite/smoothysearch/releases/latest)
